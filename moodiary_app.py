...
def apply_custom_css():
    st.markdown("""
        ...
        h1, h2, h3 { font-family: 'Noto Sans KR', sans-serif !important; } /* 제목 폰트 통일 */
        ...
        /* 5. 사이드바 버튼 (메인 버튼과 분리된 스타일) */
        section[data-testid="stSidebar"] .stButton > button {
            background: #eee; /* 메뉴 배경색 */
            color: #333;
            border-radius: 10px;
            font-weight: 600;
            margin-bottom: 5px;

...
def recommend_music(emotion):
    ...
    try:
        # ⭐️⭐️⭐️ market="KR" 삭제 (글로벌 검색 허용) ⭐️⭐️⭐️
        ...
        for t in tracks:
            ...
            if tid and tid not in st.session_state.recent_music_ids:
                name = t.get("name")
                if name:
                    valid_candidates.append({"id": tid})
